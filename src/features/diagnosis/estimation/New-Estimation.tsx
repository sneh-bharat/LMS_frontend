...
import SelectBranch from '@/features/diagnosis/diagnostic-booking/select-branch';
import AddInvestigationsModal from '@/features/diagnosis/diagnostic-booking/AddInvestigationsModal';
import AddReferringDoctorModal from '@/features/diagnosis/diagnostic-booking/booking/AddReferringDoctorModal';
import AddReferrerModal from '@/features/diagnosis/diagnostic-booking/booking/AddReferrerModal';
import DiagnosticIntakeForm from '@/features/diagnosis/diagnostic-booking/DiagnosticIntakeForm';
import {
  BLANK_BOOKING_FORM,
  createEstimationMetaDefaults,
  type DiagnosticBookingFormState,
  type EstimationMetaState,
} from '@/features/diagnosis/diagnostic-booking/bookingFormTypes';
import { mapPatientToBookingForm } from '@/features/diagnosis/diagnostic-booking/patientFormUtils';
