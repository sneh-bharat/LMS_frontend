              ...
              <div key={branch.id} className="glass rounded-[3rem] p-8 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 border border-gray-300 flex flex-col group relative overflow-hidden">
                ...
                <div className="mt-auto flex items-center justify-between relative z-10">
                  ...
                  <div className="flex items-center gap-2">
                    <Button variant="outline" className="rounded-2xl p-3 h-10 w-10 aspect-square hover:bg-slate-50 hover:border-slate-300">
                      <ChevronRight size={20} />
                    </Button>
                    <Button variant="ghost" className="p-3 text-slate-300 hover:text-slate-600 transition-colors h-10 w-10 aspect-square rounded-full">
