...
import { Grid, Bell, User, Phone, CalendarCheck } from 'lucide-react';
    ...
    return (
        <header className="h-16 bg-white border-b border-slate-200 flex items-center px-6 gap-4 sticky top-0 z-[100] transition-all shadow-sm">
            ...
            <button
                ...
                className="w-10 h-10 flex items-center justify-center text-slate-500 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition-all active:scale-95"
            >
                <Grid size={20} />
            </button>
            ...
            <div className="flex flex-col">
                ...
                <span className="font-bold text-lg text-slate-900 leading-none tracking-tight">
                    Customer Support & <span className="text-emerald-600">Quality Control</span>
                </span>
            </div>
            ...
            <div className="ml-auto flex items-center gap-8">
                    ...
                    <div className="flex flex-col items-end">
                        ...
                        <div className="flex items-center gap-1.5">
                            <div className="h-1.5 w-12 bg-slate-100 rounded-full overflow-hidden">
                                <div className="h-full bg-green-500 w-[65%] shadow-[0_0_5px_rgba(34,197,94,0.4)]"></div>
                            </div>
                ...
                <div className="flex items-center gap-2">
                    <button className="p-3 text-slate-400 hover:text-emerald-600 hover:bg-emerald-50 rounded-xl transition-all relative group" aria-label="Notifications">
                ...
                <div className="flex items-center gap-3 p-1 rounded-xl border border-slate-200 shadow-sm hover:border-slate-300 transition-all cursor-pointer group bg-slate-50">
                    <div className="flex flex-col items-end pl-3">
                        <span className="text-xs font-bold text-slate-900 group-hover:text-emerald-600 transition-colors tracking-tight">Admin User</span>
                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Level 10 Master</span>
                    </div>
                    <div className="w-9 h-9 rounded-lg custom-gradient flex items-center justify-center text-white transition-all">
                        <User size={18} />
                    </div>
                </div>
            </div>
