...
const NAV = [
  ...
  },
  {
    ...
    children: [{ label: "Daily Worksheet", href: "/dailyworksheet" }],
  },
  {
    id: "masters",
    label: "Masters",
    ...
    children: [
      ...
      { label: "Pathologist", href: "/pathologist" },
      { label: "Branch Manager", href: "/branch-manager" },
                ...
                >
                  <span
                    className={cn(
                      ...
                      (groupOpen && isOpen) || (isItemActive && !isOpen)
                        ? "text-white"
                        : "text-teal-100/80 group-hover:text-white",
                    )}
                  >
                    {item.icon}
                  </span>
