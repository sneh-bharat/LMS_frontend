      ...
      <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        {showInitialLoader ? (
          <div className={listingLoadingBox}>
            ...
            <p className={listingLoadingText}>Loading blood collectors…</p>
          </div>
        ) : !isUsernameApiSearch && rows.length === 0 ? (
          <div className={listingEmptyBox}>
            <p className={listingEmptyTitle}>No blood collectors found.</p>
          </div>
        ) : (
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div className="min-w-0">
                                ...
                                {row.collectionCenter?.trim() ? (
                                  <div className={`${listingRowSub} truncate max-w-55 mt-0.5`}>
                                    {row.collectionCenter.trim()}
                                  </div>
                                ) : null}
                              </div>
